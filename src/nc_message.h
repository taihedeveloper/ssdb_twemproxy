...
#define MSG_TYPE_CODEC(ACTION)                                                                      \
	...
	ACTION( REQ_REDIS_HLRANGE )                 /* redis request - hlists */                        \
    ACTION( REQ_REDIS_HRPUSH )                                                                      \
	ACTION( REQ_REDIS_HLPUSH )                                                                      \
	ACTION( REQ_REDIS_HRPUSHX )                                                                     \
	ACTION( REQ_REDIS_HLPUSHX )                                                                     \
	ACTION( REQ_REDIS_HLINSERT )                                                                    \
	ACTION( REQ_REDIS_HRPOP )                                                                       \
	ACTION( REQ_REDIS_HLPOP )                                                                       \
	ACTION( REQ_REDIS_HLLEN )                                                                       \
	ACTION( REQ_REDIS_HLINDEX )                                                                     \
	ACTION( REQ_REDIS_HLSET )                                                                       \
	ACTION( REQ_REDIS_HLTRIM )                                                                      \
	ACTION( REQ_REDIS_HLREM )                                                                       \
	...
	ACTION( REQ_REDIS_HSADD )                   /* redis requests - hsets */                        \
    ACTION( REQ_REDIS_HSCARD )                                                                      \
    ACTION( REQ_REDIS_HSDIFF )                                                                      \
    ACTION( REQ_REDIS_HSDIFFSTORE )                                                                 \
    ACTION( REQ_REDIS_HSINTER )                                                                     \
    ACTION( REQ_REDIS_HSINTERSTORE )                                                                \
    ACTION( REQ_REDIS_HSISMEMBER )                                                                  \
    ACTION( REQ_REDIS_HSMEMBERS )                                                                   \
    ACTION( REQ_REDIS_HSMOVE )                                                                      \
    ACTION( REQ_REDIS_HSPOP )                                                                       \
    ACTION( REQ_REDIS_HSRANDMEMBER )                                                                \
    ACTION( REQ_REDIS_HSREM )                                                                       \
    ACTION( REQ_REDIS_HSUNION )                                                                     \
    ACTION( REQ_REDIS_HSUNIONSTORE )                                                                \
    ...
    ACTION( REQ_REDIS_HZADD )                   /* redis requests - hsorted sets */                 \
    ACTION( REQ_REDIS_HZCARD )                                                                      \
    ACTION( REQ_REDIS_HZCOUNT )                                                                     \
    ACTION( REQ_REDIS_HZINCRBY )                                                                    \
    ACTION( REQ_REDIS_HZINTERSTORE )                                                                \
    ACTION( REQ_REDIS_HZRANGE )                                                                     \
    ACTION( REQ_REDIS_HZRANGEBYSCORE )                                                              \
    ACTION( REQ_REDIS_HZRANK )                                                                      \
    ACTION( REQ_REDIS_HZREM )                                                                       \
    ACTION( REQ_REDIS_HZREMRANGEBYRANK )                                                            \
    ACTION( REQ_REDIS_HZREMRANGEBYSCORE )                                                           \
    ACTION( REQ_REDIS_HZREVRANGE )                                                                  \
    ACTION( REQ_REDIS_HZREVRANGEBYSCORE )                                                           \
    ACTION( REQ_REDIS_HZREVRANK )                                                                   \
    ACTION( REQ_REDIS_HZSCORE )                                                                     \
    ACTION( REQ_REDIS_HZUNIONSTORE )                                                                \
